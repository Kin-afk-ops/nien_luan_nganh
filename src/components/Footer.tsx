...
const Footer: React.FC = () => {
  return (
    <footer className={styles.footer}>
      <img src="/banner/footer_banner.png" alt="Fotter Banner" className={styles.footer_banner}></img>
      <div className={styles.footerContainer}>
        ...
        <div className={styles.footerColumn}>
          ...
          <p><FaPhone /> 0 chín không chiên</p>
          <p><FaEnvelope /> lienhe@web.vn</p>
          <p>
            <FaMapMarkerAlt /> Số nhà B2.25 Vinhomes Gardenia, Hàm Nghi,  
            P. Cầu Diễn, Q. Nam Từ Liêm, TP. Hà Nội
          </p>
        ...
        <div className={styles.footerColumn}>
          ...
          <div className={styles.footerLogo}>
            ...
            <a href="https://www.tiktok.com/foryou?lang=vi-VN" className={styles.icon}>
